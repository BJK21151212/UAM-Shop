                ...
                <div class="header-menu">
                    <ul>
                        @auth
                            ...
                            <li><a href="{{route('admin')}}">My Account</a></li>
                            @else
                            <li><a href="{{route('user')}}">My Account</a></li>
                            @endif
                            <li><a href="{{route('user.logout')}}">Logout</a></li>
                        @else
                        <li><a data-toggle="modal" data-target="#login-modal"  href="{{route('login.form')}}" class="">Log In</a></li>
                        @endauth
...
<div class="header-middle sticky-header" data-sticky-options="{'mobile': true}">
    <div class="container">
        ...
        <div class="header-right w-lg-max pl-2">
            ...
            <a href="{{route('login.form')}}" class="header-icon header-icon-user">
