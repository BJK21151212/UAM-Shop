                        ...
                        <nav class="toolbox sticky-header" data-sticky-options="{'mobile': true}">
                            <div class="toolbox-left">
                                ...
                                <div class="toolbox-item toolbox-sort">
                                    ...
                                    <div class="select-custom">
                                        <select name="sortBy" class="form-control sortBy" onchange="this.form.submit();">
                            ...
                            <div class="toolbox-right">
                                ...
                                <div class="toolbox-item layout-modes">
                                    ...
                                    <a href="{{route('product-lists')}}" class="layout-btn btn-list" title="List">
                                        ...
                                        <div class="product-default">
                                            <figure>
                                                <a href="{{route('product-detail',$product->slug)}}">
                                                    ...
                                                    @endphp
                                                    <img src="{{$photo[0]}}" width="280" height="280" alt="{{$photo[0]}}" />
                                                    <img src="{{$photo[0]}}" width="280" height="280" alt="{{$photo[0]}}" />
                                                </a>
                                                @if($product->discount)
                                            ...
                                            <div class="product-details">
                                                ...
                                                <div class="product-action">
                                                    <a href="{{route('add-to-wishlist',$product->slug)}}" data-id="{{$product->id}}" class="btn-icon-wish" title="wishlist"><i
                                                            class="icon-heart"></i></a>
                                                    <a href="{{route('add-to-cart',$product->slug)}}" data_id="{{$product->id}}" data-name="{{$product->slug}}"  class="btn-icon btn-add-cart product-type-simple"><i
                                                ...
                                                <div class="product-default left-details product-widget">
                                                    ...
                                                    @endphp
                                                        <a href="product.html">
                                                            ...
                                                            <img src="{{$photo[1]}}" width="75" height="75" alt="product" />
                                                        </a>
                                                    </figure>
                                                    <div class="product-details">
